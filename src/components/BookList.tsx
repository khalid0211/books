          ...
          {viewMode === "table" ? <div className="catalog-table overflow-x-auto rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
            <table className="w-full table-fixed text-sm md:table-auto">
              <thead className="bg-slate-100 text-left text-slate-600 dark:bg-slate-800 dark:text-slate-300">
                <tr>
                  <th className="w-20 px-2 py-0 font-medium md:w-auto md:px-3"><span className="md:hidden">Book ID</span><span className="hidden md:inline">Book number</span></th><th className="px-2 py-0 font-medium md:px-3">Title</th>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {books.map((b) => (
                  <tr key={b.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50"><td className="whitespace-nowrap px-2 py-0 font-mono text-slate-500 md:px-3">{bookNumber(b.id)}</td>
                    <td className="min-w-0 px-2 py-0 md:px-3 md:break-words">
